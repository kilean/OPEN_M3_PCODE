    ...
    public partial class Fo_Main : Form
    {
        ...
        */
        ...
        private void pic_Position_Click(object sender, EventArgs e) //位置設定
        {
            ...
            //內圓中心位置設定
            btn_PosSet_IDCenterPos.Visible = CurrentGwMacro[10004] == 0;

            //外圓安全位置
            btn_PosSet_ODSafePos.Visible = CurrentGwMacro[10004] == 1;

            //GW 內圓工件中心位置
            la_PartCenterPosX.Text = CurrentGwMacro[10002].ToString(Units.DisplayFmt);

            //GW 外圓安全位置 
            la_ODSafePos_X.Text = tb_Gw2_OD_SafePosX.Text = CurrentGwMacro[10003].ToString(Units.DisplayFmt);
